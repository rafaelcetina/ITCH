...
$( document ).ready(function() {
    ...
    if($('body').hasClass('material-menu-active')){   material_menu_active();   }    
    
    function material_menu_active(){
    ...
    setTimeout(function() {
        ...
        $('.circle-slider-ball-left').click(function() {$('.circle-slider').trigger('next.owl.carousel');	return false;}); 
        $('.circle-slider-ball-right').click(function() {$('.circle-slider').trigger('prev.owl.carousel');	return false;});
        ...
        $('.next-home-slider, .homepage-slider-ball-left').click(function() {$('.homepage-slider-transition, .homepage-slider-transition-2, .homepage-slider-transition-3, .homepage-slider-no-transition').trigger('next.owl.carousel');	return false;}); 
        $('.prev-home-slider, .homepage-slider-ball-right').click(function() {$('.homepage-slider-transition, .homepage-slider-transition-2, .homepage-slider-transition-3, .homepage-slider-no-transition').trigger('prev.owl.carousel');	return false;});
    ...
    $('#content').on('scroll', function () {
        ...
        if (inside_header == true) {
            ...
            $('.footer-menu-open').removeClass('footer-menu-hidden');
        } 
        if (footer_reached == true){            
            //$('.back-to-top-badge').removeClass('back-to-top-badge-visible');
            $('#header-fixed').addClass('hide-header');
            $('.footer-menu-open').addClass('footer-menu-hidden');
        }
    });
    ...
    function generate_map(){
        ...
        $('.map-fullscreen iframe').css('height', map_height+60);
    };
    generate_map();
    ...
    function align_cover_elements(){
        ...
        $('.cover-slide').css('width', cover_width);
        $('.cover-slide').css('height', cover_height+60);
        $('.cover-slide .overlay').css('width', cover_width);
        $('.cover-slide .overlay').css('height', cover_height+60);
